...
pub use crate::utils::compiler_engine::grammar_trait::{Expressions, ProgramStructure, Statements};
...
pub type CompilerFunc = dyn FnMut(&mut File, &mut JackTokenizer, &mut i8) -> Option<String>;
